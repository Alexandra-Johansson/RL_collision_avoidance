...
class Train_DDPG():
    def __init__(self, parameters):
        ...
        self.filename = os.path.join(self.output_folder, 'DDPG_training_' + datetime.now().strftime("%Y.%m.%d-%H.%M.%S"))
    ...
    def train(self):
        ...
        n_actions = training_env.action_space.shape
        ...
        model = DDPG('MultiInputPolicy',
                    ...
                    train_freq = (int(self.parameters['training_freq']), "step"), # int(eval_env.CTRL_FREQ/2)

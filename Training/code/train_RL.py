...
if __name__ == "__main__":
    ...
    if rl_algorithm == "PPO":
        test_param_learning_rate = [8e-4]
        test_param_reward_target_distance = [-0.0]
        test_param_reward_object_distance_delta = [0.0]
        test_param_reward_in_target = [0.0]
        test_param_reward_object_distance = [0.0]
        test_param_reward_rpy = [0.0]
        test_param_obs_timestep = [False]
        test_param_obs_action_difference = [True]
        test_param_entropy_coefficent = [0]
        test_param_reward_truncation = [-1.0]
        test_param_clip_range = [0.3]
        ...
        for learning_rate in test_param_learning_rate:
            ...
            for reward_target_distance in test_param_reward_target_distance:
                ...
                for reward_object_distance_delta in test_param_reward_object_distance_delta:
                    parameters_PPO['reward_object_distance_delta'] = reward_object_distance_delta
                    ...
                    for reward_in_target in test_param_reward_in_target:
                        ...
                        for reward_object_distance in test_param_reward_object_distance:
                            ...
                            for reward_rpy in test_param_reward_rpy:
                                parameters_PPO['reward_rpy'] = reward_rpy

                                for obs_timestep in test_param_obs_timestep:
                                    parameters_PPO['obs_timestep'] = obs_timestep

                                    for reward_truncation in test_param_reward_truncation:
                                        parameters_PPO['reward_truncation'] = reward_truncation
                                        ...
                                        for obs_action_difference in test_param_obs_action_difference:
                                            ...
                                            for entropy_coefficient in test_param_entropy_coefficent:
                                                parameters_PPO['entropy_coefficient'] = entropy_coefficient

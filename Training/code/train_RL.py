...
parameters = {
    ...
    'reward_angular_velocity_delta': -10.0, # Negative reward for changing angle
    ...
    'total_timesteps': int(2e6),  # Total timesteps to train
    'nr_of_env': 10,  # Number of environments to train in parallel
}

if __name__ == "__main__":
    test_params_learning_rate = [3*1e-5,2*1e-4,1e-3]

    for learning_rate in test_params_learning_rate:
